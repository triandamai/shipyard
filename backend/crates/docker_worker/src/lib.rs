...
//!
//! # async fn example(engine: Arc<dyn shipyard_docker::engine::DockerEngine>, db: sqlx::PgPool, mqtt: Arc<shipyard_mqtt::MqttPublisher>) -> shipyard_common::error::AppResult<()> {
